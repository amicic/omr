								...
								bool threadAtSafePoint)
{
	 ...
	 * However with some other kickoff criteria (for example, language specific, like class unloading)
	 * much soonr, so that remainingFree is significantly higher than kickoffThreshold.
	 * Since CardCleaningThreshold was calculated irrespective of actual remainingFree at the moment of kickoff
	 * (during tuneToHeap that occurred at the end of last global GC) it needs to be adjusted by
	 * the difference between actual remainingFree at the time of kickoff and kickoff threshold.
	 */
